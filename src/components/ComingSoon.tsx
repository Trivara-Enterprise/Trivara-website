...
export const ComingSoon = () => {
    ...
    useEffect(() => {
        // Immediate first update using requestAnimationFrame (runs on next frame)
    ...
    return (
        <div className="min-h-screen bg-black flex flex-col items-center justify-center relative overflow-hidden px-4 sm:px-6">
            <img
                ...
                alt=""
                className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[800px] md:w-[1000px] max-w-none opacity-70 blur-[2px]"
            />

            <div className="relative z-10 mb-8 sm:mb-12">
                <img className="h-12 sm:h-16 w-auto" src="/images/logo.jpeg" alt="Trivara" />
            </div>
                        ...
                        <div key={index} className="flex flex-col items-center">
                            <div className="relative group">
                                ...
                                <div className="relative w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-black rounded-xl sm:rounded-2xl flex items-center justify-center border border-indigo-500/20">
                                    <span className="text-xl sm:text-3xl md:text-4xl font-bold text-white" suppressHydrationWarning>
            ...
            <div className="relative z-10 mt-12 sm:mt-16 flex items-center gap-6">
                <a href={SITE_CONFIG.socials.twitter} className="text-white/40 hover:text-indigo-400 transition" aria-label="Twitter">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                </a>
                <a href={SITE_CONFIG.socials.linkedin} className="text-white/40 hover:text-indigo-400 transition" aria-label="LinkedIn">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                    </svg>
                </a>
                <a href={SITE_CONFIG.socials.instagram} className="text-white/40 hover:text-indigo-400 transition" aria-label="Instagram">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
