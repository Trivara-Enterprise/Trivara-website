...
const workSteps = [
  {
    ...
    description:
      "We begin by understanding operational complexity, business constraints, and long-term goals. Our team defines the system architecture, data flows, and scalability blueprint.",
  ...
  },
  {
    ...
    title: "SYSTEM DESIGN",
    description:
      "We design intelligent, modular systems built for performance and adaptability. Every component is engineered to integrate seamlessly with existing infrastructure.",
  ...
  },
  {
    ...
    description:
      "Implementation follows strict engineering standards. We ensure the solution scales horizontally and remains resilient under high load while maintaining peak performance.",
  ...
  },
  {
    ...
    description:
      "Continuous monitoring and automated scaling ensure your infrastructure evolves with your user base without compromising on speed or security.",
...
const Work = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-black text-white py-20 px-6 flex flex-col justify-center overflow-hidden"
    >
      {/* Header Section */}
      <div ref={headerRef} className="text-center mb-5">
        ...
        <p className="max-w-xl mx-auto text-gray-200 text-sm leading-relaxed">
          The methodologies behind our ability to consistently deliver
      ...
      <div
        ref={contentRef}
        className="relative max-w-6xl mx-auto w-full flex flex-col items-center"
      >
        {/* Step Content */}
            ...
            >
              <div
                className={`h-[2px] transition-all duration-500 ${
                  index === activeIndex
                    ? "bg-white w-20"
                    : "bg-gray-800 w-12 group-hover:bg-gray-500"
                }`}
              />
              <span
                className={`mt-2 text-[10px] tracking-widest transition-colors ${
